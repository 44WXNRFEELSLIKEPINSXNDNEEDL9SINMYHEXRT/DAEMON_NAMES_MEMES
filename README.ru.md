...
4–12-поточном CPU) и холодные старты в несколько минут. **Это известное
ограничение бесплатного/дешёвого CPU-хостинга, а не баг — не «чините» его
сменой модели без обсуждения.**
